      ...
      <div className="mb-10">
        ...
        >
          <h1 className="font-medium text-deepBlue">
            {selectedCatValue ? selectedCatValue : "Choose Category"}
          </h1>
          <MdKeyboardArrowDown />
        </div>
      ...
      <div className="mb-10">
        ...
        >
          <h1 className="font-medium text-gray-600">
            {selectedSubCatValue ? selectedSubCatValue : "Choose Sub Category"}
          </h1>
          <MdKeyboardArrowDown />
        </div>
...
export default CreatedFormDropDown;
