  ...
  useEffect(() => {
    const getSingleCategoryInformation = async () => {
      try {
        ...
        console.error("Error fetching Uom information:", error.message);
      }
    };
  ...
  const submitFormData = async () => {
    ...
    try {
      ...
      if (response.ok === true) {
        ...
        toast.success("The Uom has been updated successfully!");
      }
      ...
      toast.error("Failed to Uom category. Please try again.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative">
            ...
            <label
              ...
              htmlFor="xcodetype"
            >
              Uom<span className="text-red">*</span>
            </label>
          </div>
          <div className="flex flex-row gap-4 mt-5">
            {updateSts ? (
              <>
                <Link href={"/dashboard/uom/create"}>
